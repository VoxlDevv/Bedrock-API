...
world.afterEvents.playerBreakBlock.subscribe((cb) => AfterEvents.emit("playerHitBlock", cb));
...
world.afterEvents.projectileHitEntity.subscribe((cb) => AfterEvents.emit("projectileHitBlock", cb));
