...
// After events
world.afterEvents.blockBreak.subscribe((cb) => AfterEvents.emit("blockBreak", cb));
world.afterEvents.blockExplode.subscribe((cb) => AfterEvents.emit("blockExplode", cb));
world.afterEvents.blockPlace.subscribe((cb) => AfterEvents.emit("blockPlace", cb));
...
world.afterEvents.entityRemoved.subscribe((cb) => AfterEvents.emit("entityRemoved", cb));
...
world.afterEvents.projectileHit.subscribe((cb) => AfterEvents.emit("projectileHit", cb));
